...
2. SEO Description: Max 160 karakter. Call-to-action içermeli. FİYAT BİLGİSİ YAZMA. "En uygun fiyat" gibi genel ifadeler kullanabilirsin ama rakam belirtme.
3. Ürün Açıklaması: MİNİMUM 500 KELİME (BU ZORUNLU, 500'DEN AZ KELİME KABUL EDİLMEZ). Aşağıdaki yapıda olmalı:
   ...
   - "## {Ürün Adı} Teknik Detayları" alt başlığı (ölçü, ebat, kapasite, güç, malzeme, ağırlık gibi teknik özellikleri AI olarak tahmin ederek detaylı yaz)
   - "## {Ürün Adı} Fiyatı" alt başlığı (fiyat RAKAMI YAZMA, "uygun fiyat", "rekabetçi fiyat" gibi genel ifadeler kullan)
...
5. ASLA FİYAT RAKAMI YAZMA. Ne TL ne de herhangi bir sayısal fiyat bilgisi olmamalı.
6. Teknik özellikleri (boyut, ölçü, kapasite, malzeme, güç vb.) ürün adından ve kategorisinden tahmin ederek detaylı şekilde yaz.
7. İçerik tamamen Türkçe, doğal, özgün ve profesyonel olmalı.
...
NOT: Fiyat bilgisi YAZMA. Ne title, ne description, ne açıklamada fiyat rakamı olmasın.
