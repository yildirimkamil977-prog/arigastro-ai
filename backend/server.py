...
async def startup():
    ...
    scheduler.add_job(_sched_competitor_scan, CronTrigger(hour=18, minute=25, timezone=TR), id="competitor_scan_cron", name="Rakip Tara+Fiyat Guncelle TEST (18:25 TR)", replace_existing=True, misfire_grace_time=3600)
